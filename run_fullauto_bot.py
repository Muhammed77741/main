...
Usage:
    ...
    python run_fullauto_bot.py --dry-run  # Test mode (no real trades)
"""
...
def start_bot(config):
    ...
    try:
        from live_bot_mt5_fullauto import LiveBotMT5FullAuto
    except ImportError:
        print("❌ Failed to import LiveBotMT5FullAuto")
        print("   Make sure live_bot_mt5_fullauto.py exists in smc_trading_strategy/")
        return False
