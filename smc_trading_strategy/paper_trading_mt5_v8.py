"""
Live Trading Bot V8 - Best Configuration
Uses V8 parameters: partial close 30%/30%/40%, widened SL, market regime detection
"""
...
class LiveTradingBotV8:
    """
    Live trading bot with V8 configuration (BEST!)
    ...
    - Partial close: 30%/30%/40% (NEW!)
    - Widened SL: 2nd swing point
    ...
    def __init__(self, telegram_token=None, telegram_chat_id=None, check_interval=3600,
        ...
        print("✅ Live Trading Bot V8 initialized")
    ...
    def open_position(self, signal, timestamp, regime):
        """Open a new position with V8 parameters"""
    ...
    def check_open_positions(self):
        """Check open positions with V8 logic: TP, trailing, timeout"""
